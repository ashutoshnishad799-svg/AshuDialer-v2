...
@Database(
    entities = [CallLogEntity::class, BlockedNumberEntity::class, CallNoteEntity::class, SimRoutingEntity::class, VibrationRuleEntity::class, QuietHoursEntity::class, PrivateSpaceEntity::class, LockedNumberEntity::class, CallbackReminderEntity::class],
    version = 9,
    exportSchema = false
)
