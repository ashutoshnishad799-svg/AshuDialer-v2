...
sealed class LocalBackupImportResult {
    data class Success(
        ...
        val simRulesCount: Int, val vibrationRulesCount: Int
...
class LocalBackupRepository(
    ...
    private suspend fun applyPayloadJson(json: JSONObject): LocalBackupImportResult.Success {
        ...
        return LocalBackupImportResult.Success(callLogCount, blockedCount, notesCount, simRulesCount, vibrationRulesCount)
    }
}
